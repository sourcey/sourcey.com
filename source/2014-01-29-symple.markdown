...
![Symple Logo](symple-logo-120.png "Symple Logo"){: .align-left} Symple is a messaging, presence and remoting protocol with implementations in C++ and JavaScript for seamless communication between desktop and browser applications.
