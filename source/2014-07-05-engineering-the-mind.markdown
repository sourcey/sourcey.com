...
In nature, as well as the human mind, we can observe geometric patterns and principles that reoccur - we call it sacred geometry. As energy collides and interacts at the mercy of the <!--variables and constants that comprise the--> laws of nature, it stands to reason that there will be convergent similarities. 
